...
https://github.com/Star-endMC/Star-end-License/tree/v2.1.2
...
If you are building an addon or derivative project, you are fully permitted to achieve compatibility. However, you cannot directly duplicate our assets or code to redistribute it as your own.

## Overview

This Software License Agreement ("Agreement") governs the use, distribution, and modification of any software, binary, source code, or related materials provided by Star-end ("the Software").

This Agreement distinguishes between:
1. End Users (players and individuals)
2. Distributors (modpacks, bundles, or hosted platforms)

This Agreement applies globally to the maximum extent permitted by applicable law. Where local law conflicts with specific provisions of this Agreement, those provisions are modified only to the minimum extent required by law, and all other provisions remain in full force and effect.
...
- The Software is not embedded or repackaged directly inside third-party binaries.

- The distribution bundle does not enforce artificial access restrictions or paywalls that conflict with Section 4.2 (Commercial Restrictions).
